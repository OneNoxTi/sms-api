...
![image1](/img/instruction/sms/reports/bulk_sms_reports/image1.png)
...
![image3](/img/instruction/sms/reports/bulk_sms_reports/image3.png)

## Bulk sms reports list

All bulk sms reports are located in the table on the **BULK SMS** tab.

![image4](/img/instruction/sms/reports/bulk_sms_reports/image4.png)
...
![image5](/img/instruction/sms/reports/bulk_sms_reports/image5.png)

## Additional actions with mailing

On the right side of the message text field there is a menu of additional actions:

![image6](/img/instruction/sms/reports/bulk_sms_reports/image6.png)
...
![image7](/img/instruction/sms/reports/bulk_sms_reports/image7.png)
...
![image8](/img/instruction/sms/reports/bulk_sms_reports/image8.png)
...
![image9](/img/instruction/sms/reports/bulk_sms_reports/image9.png)
...
![image10](/img/instruction/sms/reports/bulk_sms_reports/image10.png)

#### Report table

The information in the report is presented in separate columns:

![image11](/img/instruction/sms/reports/bulk_sms_reports/image11.png)
...
![image12](/img/instruction/sms/reports/bulk_sms_reports/image12.png)
