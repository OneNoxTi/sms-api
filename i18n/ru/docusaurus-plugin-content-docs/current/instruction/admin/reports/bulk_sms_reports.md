...
| 9 | **Доставлено** | Количество доставленных сообщений. Нажмите **СОХРАНИТЬ СПИСОК**, чтобы сохранить список контактов, на которые было доставлено SMS, в отдельной [адресной книге](../../client/address_book/recipients) |
