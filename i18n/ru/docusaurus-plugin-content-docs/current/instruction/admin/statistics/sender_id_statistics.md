...
![image1](/img/ru/admin_statistics_sender_id/image1.png "Альфаімена") <center><u>Альфаімена - фото 1</u></center>
...
![image2](/img/ru/admin_statistics_sender_id/image2.png "Альфаімена") <center><u>Альфаімена - фото 2</u></center>

## Експорт звіту

Щоб експортувати статистичну звітність, натисніть на іконку кнопки **Експорт** праворуч від кнопки **ПОШУК**.

![image3](/img/ru/admin_statistics_sender_id/image3.png "Альфаімена") <center><u>Альфаімена - фото 3</u></center>
...
![image4](/img/ru/admin_statistics_sender_id/image4.png "Альфаімена") <center><u>Альфаімена - фото 4</u></center>
...
![image5](/img/ru/admin_statistics_sender_id/image5.png "Альфаімена") <center><u>Альфаімена - фото 5</u></center>

## Таблиця статистики

Всі статистичні дані розташовані в таблиці в окремих колонках:

![image6](/img/ru/admin_statistics_sender_id/image6.png "Альфаімена") <center><u>Альфаімена - фото 6</u></center>
