...
На данной вкладке вы можете просмотреть отчеты по массовым рассылкам SMS за определенный период, а также экспортировать отчет в файл xlsx.
...
|  №  | Действие | Описание |
| :-: | -------- | -------- |
| 1 | **ДЕТАЛЬНО** | Просмотреть детальный [отчет по рассылке](#отчет-по-рассылке) |
...
|  №  | Описание |
| :-: | -------- |
| 1 | [Детальная информация](#детальная-информация) про SMS рассылку |
...
| 9 | **Доставлено** | Количество доставленных сообщений. Нажмите **СОХРАНИТЬ СПИСОК**, чтобы сохранить список контактов, на которые было доставлено SMS, в отдельной [адресной книге](../address_book/recipients) |
...
Информация в отчете представлена ​​в отдельных колонках:
