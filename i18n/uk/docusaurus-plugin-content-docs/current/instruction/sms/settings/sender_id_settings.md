...
Дані розташовані в окремих стовпчиках:
...
Щоб видалити відправника, встановіть прапорець навпроти потрібного відправника і натисніть іконку кнопки **Видалити** у верхньому правому куті таблиці.
