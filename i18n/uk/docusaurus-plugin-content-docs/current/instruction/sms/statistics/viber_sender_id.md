...
У цій вкладці ви можете переглянути статистику по іменам відправника (альфаіменам), а також перевірити ефективність розсилки.

Щоб відкрити дану вкладку, виберіть **SMS** → **Аналітика** у боковому меню та перейдіть на вкладку **АЛЬФАІМЕНА VIBER**.

![image1](/img/uk/sms_statistics_viber_sender_id/image1.png)
...
![image2](/img/uk/sms_statistics_viber_sender_id/image2.png)

## Експорт звіту

Щоб експортувати статистичну звітність, натисніть на іконку кнопки **Експорт** праворуч від кнопки **ПОШУК**.

![image3](/img/uk/sms_statistics_viber_sender_id/image3.png)
...
![image4](/img/uk/sms_statistics_viber_sender_id/image4.png)
...
![image5](/img/uk/sms_statistics_viber_sender_id/image5.png)

## Таблиця статистики

Всі статистичні дані розташовані в таблиці у відособлених стовпчиках:

![image6](/img/uk/sms_statistics_viber_sender_id/image6.png)
